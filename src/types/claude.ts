...
export interface ClaudeCommandOptions {
  ...
  sessionId?: string; // Optional session ID for trace generation
  template?: string; // Template to use for workspace initialization, defaults to 'default'
}
...
export interface ClaudeEnvironmentVars {
  ...
  BOT_EMAIL?: string;
  VERCEL_TOKEN?: string;
  CLAUDE_TRACE_SESSION_ID?: string;
  CLAUDE_TRACE_OUTPUT_DIR?: string;
